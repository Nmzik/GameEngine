...
#elif BX_COMPILER_CLANG && !BX_PLATFORM_EMSCRIPTEN && !BX_PLATFORM_IOS && BX_CLANG_HAS_EXTENSION(attribute_ext_vector_type)
...
#if (BX_SIMD_LANGEXT || BX_SIMD_NEON || BX_SIMD_SSE || BX_SIMD_AVX)
